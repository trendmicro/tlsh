...
echo "rm -rf bin build lib Testing/tmp test/simple_unittest test/tlsh_unittest VERSION include/version.h"
      rm -rf bin build lib Testing/tmp test/simple_unittest test/tlsh_unittest VERSION include/version.h
